...
setup(
    ...
    description='Jenkins Configuration as Code reloader',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/nthienan/jcasc-reloader',
    author='An Nguyen',
    ...
    keywords='jcasc, jenkins, devops, jcasc-reloader',
    ...
    #
    packages=['jcasc_reloader'],
    package_dir={'jcasc_reloader': 'src'},
    scripts=['bin/jcasc-reloader'],
    ...
    project_urls={
        'Bug Reports': 'https://github.com/nthienan/jcasc-reloader/issues',
        'Source': 'https://github.com/nthienan/jcasc-reloader',
    },
